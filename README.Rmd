...
* **meteo_monthly()** - Downloading monthly meteorological data from SYNOP/KLIMAT/OPAD stations made available in the danepubliczne.imgw.pl database

* **meteo_daily()** - Downloading daily meteorological data from SYNOP/KLIMAT/OPAD stations made available in the danepubliczne.imgw.pl database

* **meteo_hourly()** -  Downloading hourly meteorological data from SYNOP/KLIMAT/OPAD stations made available in the danepubliczne.imgw.pl database
...
* **hydro_yearly()** - Downloading semiannual and annual hydrological data from the danepubliczne.imgw.pl database
