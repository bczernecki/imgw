...
2. Analizy hydrologiczne często koncentrują się na jednej grupy zjawisk, np. związanych z przepływami maksymalnymi.
...
4. Uzyskane wyniki mogą zostać następnie zwizualizowane w formie przestrzennej za pomocą np. pakietów GIS: `sf` i `tmap`. Poniżej zamieszczono przykładowy kod dla średnich maksymalnych przepływów rocznych:
