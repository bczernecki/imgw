...
Data is central to understand and analyze actual meteorological and hydrological phenomena. 
When we start working with new data, first thing we do are:

- Understanding where the data is stored and how it can be retrieved
- Downloading the data
- Preparing the data to a readable format (if the format is unclear)

The main goal of the **imgw** package is to give access to the Polish database of meteorological and hydrological parameters.
...
- `meteo()` - downloading hydrological the data with interval the user want to choose

3. Sounding meteo: 

- `meteo_sounding` -----------------------------------

Those functions have similar arguments allowing to choose:
